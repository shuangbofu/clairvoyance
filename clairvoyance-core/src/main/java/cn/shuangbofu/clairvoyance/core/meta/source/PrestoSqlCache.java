...
public enum PrestoSqlCache {
    ...
    private final ExecutorService executorService = Executors.newFixedThreadPool(4, r -> new Thread(r, "PRESTO-QUERY-" + counter.getAndIncrement()));
