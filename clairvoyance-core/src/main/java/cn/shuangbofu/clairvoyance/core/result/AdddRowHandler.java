...
public class AdddRowHandler extends AbstractResultHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AdddRowHandler.class);
    ...
    private Map<String, Object> sortMap(Map<String, Object> originMap) {
        ...
        List<String> xKeys = getLayer().getAllX().stream().map(i -> i.getUniqId().toString()).collect(Collectors.toList());
